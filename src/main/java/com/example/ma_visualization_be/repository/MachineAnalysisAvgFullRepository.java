...
@Repository
public class MachineAnalysisAvgFullRepository {

    @Autowired
    private JdbcTemplate jdbcTemplate;

    public List<MachineAnalysisFullResponse> getMachineAnalysisAve(String month, int monthBack,
        ...
        return jdbcTemplate.query(sql, params, new MachineAnalysisFullRowMapper());
    }
          ...
          \s
              ...
              BEGIN
               ...
               stpHour AS (
                ...
                GROUP BY MacName)
          \s
               SELECT 'KVH' as DIV, topUse.STT as [Rank], topUse.MacName,
          ...
          \s
              ...
              BEGIN
               ...
               stpHour AS (
                ...
                GROUP BY Div, MacName)
          \s
               SELECT topUse.DIV, topUse.STT as [Rank], topUse.MacName,
    ...
    private static class MachineAnalysisFullRowMapper implements RowMapper<MachineAnalysisFullResponse> {
        @Override
        public MachineAnalysisFullResponse mapRow(ResultSet rs, int rowNum) throws SQLException {
            MachineAnalysisFullResponse response = new MachineAnalysisFullResponse();
            ...
            response.setCountMac(rs.getInt("CountMac"));
            ...
            try {
                response.setAveStopHour(rs.getBigDecimal("Ave_StopHour"));
            } catch (SQLException e) {
                response.setAveStopHour(null);
            }
